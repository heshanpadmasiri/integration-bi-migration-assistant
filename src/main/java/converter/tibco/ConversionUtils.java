...
public final class ConversionUtils {
    ...
    static BallerinaModel.TypeDesc createQueryResultType(
        ...
        BallerinaModel.TypeDesc.RecordTypeDesc recordTy =
                new BallerinaModel.TypeDesc.RecordTypeDesc(List.of(), fields, Optional.empty(), Optional.empty(),
                        Optional.of("Record"));
    ...
    static BallerinaModel.VarDeclStatment createQueryDecl(
            ActivityContext cx,
            BallerinaModel.Expression.VariableReference paramData,
